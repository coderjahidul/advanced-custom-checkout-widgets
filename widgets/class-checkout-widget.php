...
class Elementor_Advanced_Checkout_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return ['advanced-checkout-script'];
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'description' => esc_html__('Products shown for selection. Leave empty to hide product selection.', 'advanced-checkout'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .adv-checkout-col-1 h3, {{WRAPPER}} .adv-checkout-col-2 .adv-sticky-sidebar h3#order_review_heading' => 'color: {{VALUE}};',
                ],
            ]
        );
